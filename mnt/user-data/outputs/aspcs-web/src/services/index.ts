...
export const galleryService = {
  getAlbums: (params?: { page?: number; size?: number; category?: string }) =>
    api.get<PaginatedResponse<GalleryAlbum>>("/images/gallery/albums", { params }),

  getAlbumById: (id: string) =>
    api.get<GalleryAlbum>(`/images/gallery/albums/${id}`),

  createAlbum: (payload: CreateAlbumDTO) =>
    api.post<GalleryAlbum>("/images/gallery/albums", payload),

  updateAlbum: (id: string, payload: Partial<CreateAlbumDTO>) =>
    api.put<GalleryAlbum>(`/images/gallery/albums/${id}`, payload),

  deleteAlbum: (id: string) =>
    api.delete<void>(`/images/gallery/albums/${id}`),

  addImages: (albumId: string, imageUrls: string[]) =>
    api.post<GalleryAlbum>(`/images/gallery/albums/${albumId}/images`, { imageUrls }),

  deleteImage: (albumId: string, imageId: string) =>
    api.delete<void>(`/images/gallery/albums/${albumId}/images/${imageId}`),
};
